...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 9707104,
    DYNAMIC_BASE = 14949984,
    DYNAMICTOP_PTR = 9706928;
...
var INITIAL_TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 16973824;if (!Object.getOwnPropertyDescriptor(Module, 'TOTAL_MEMORY')) Object.defineProperty(Module, 'TOTAL_MEMORY', { configurable: true, get: function() { abort('Module.TOTAL_MEMORY has been replaced with plain INITIAL_TOTAL_MEMORY') } });
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=9707088;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=9706944;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 9706992, 4), 9706992);
